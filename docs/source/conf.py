...
# kedro_sagemaker_spark documentation build
...
from kedro_sagemaker_spark import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_sagemaker_spark"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_sagemaker_sparkdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_sagemaker_spark.tex",
        "kedro_sagemaker_spark Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_sagemaker_spark",
        "Project kedro_sagemaker_spark codebase.",
        "Data-Science",
    )
]
