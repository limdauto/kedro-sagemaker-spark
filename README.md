# Kedro SageMaker Spark

## Overview

This is your new Kedro project with some initial Spark configurations and an example pipeline, which was generated using `Kedro 0.17.3`.
